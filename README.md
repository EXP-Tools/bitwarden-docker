...
生产环境: ![](https://img.shields.io/badge/OS-Linux%20amd64-red.svg)

测试环境: ![](https://img.shields.io/badge/OS-Linux%20amd64-red.svg) ![](https://img.shields.io/badge/OS-Windows%2010%2B-blue.svg)
...
> 端口号 和 路由地址 之所以设计为不容易记忆，主要是为了防止公网扫描，内置 nginx 也被设置为只要访问其他路由地址一律返回 500
